...
import com.edinfotech.cursomc.dto.ClienteDTO;
...
import com.edinfotech.cursomc.services.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Nao é possivel excluir um Cliente que tem pedidos");
		}
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDTO) {
		Cliente cli = new Cliente(null, objDTO.getNome(), objDTO.getEmail(),objDTO.getCpdOuCnpj(), TipoCliente.toEnum(objDTO.getTipo()));
