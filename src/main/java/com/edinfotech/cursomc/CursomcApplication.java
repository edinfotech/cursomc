...
import com.edinfotech.cursomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Produto p7 = new Produto(null, "Celular", 800.00);
		Produto p8 = new Produto(null, "Tablet", 400.00);
		Produto p9 = new Produto(null, "Luminaria", 80.00);
		Produto p10 = new Produto(null, "Perfume", 110.00);
		Produto p11 = new Produto(null, "Playstation 4", 1110.00);
